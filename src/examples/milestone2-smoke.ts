...
console.log("denialRate", calculateDenialRate(sampleClaims));
...
console.log("highDenialPayers", flagHighDenialPayers(sampleClaims));
console.log("groupClaimsByPayer", Object.keys(groupClaimsBy(sampleClaims, "payerName")));
console.log("sortedClaimsAsc", sortClaimsById(sampleClaims, "asc").map((claim) => claim.claimId));
console.log(
  "noShowCostMiamiWeekEnding2025-03-14",
  calculateNoShowCost(sampleAppointments, sampleLocations[1], "2025-03-14")
);
console.log("noShowRateByLocation", noShowRateByLocation(sampleAppointments));
console.log("highNoShowLocations", flagHighNoShowLocations(sampleAppointments));
console.log("cmeReport", generateCMEReport(sampleClinicians, "2025-03-20"));
console.log("cliniciansAtRisk", getCliniciansAtRisk(sampleClinicians, "2025-03-20").map((c) => c.clinicianId));
console.log(
  "expiringLicencesIn90Days",
  getCliniciansWithExpiringLicences(sampleClinicians, "2025-03-20", 90).map((c) => c.clinicianId)
);
console.log("claimValidation", validateClaim(sampleClaims[0], knownLocationIds));
console.log("clinicianValidation", validateClinician(sampleClinicians[0]));
