import type { Appointment, Claim, Clinician, Location } from "@hc/types";

/** Synthetic sample data from Milestone 2 — not real PHI. */
...
export const OPS_AS_OF_DATE = "2025-03-20";
export const OPS_WEEK_ENDING = "2025-03-14";
